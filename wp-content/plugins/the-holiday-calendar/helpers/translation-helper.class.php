...
class thc_translation_helper {
	...
	static function get_read_more_text($event)
	{
		...
		$holiday_url = '<a href="' . $event->url . '" target="_blank" title="' . sprintf($read_more_string, $holiday_url, $website_url) . '">' . $event->title . '</a>';
